...
from recipe.serializers import RecipeSerializer, RecipeDetailsSerializer, IngredientSerializer
...
class PrivateRecipeAPITests(TestCase):
    ...
    def test_udapdate_recipe_assingn_ingredient(self):
    ...
    def test_filter_by_tags(self):
        ...
        r2 = create_recipe(user=self.user, title='POLISH  food')
        tag1 = Tag.objects.create(user=self.user, name='Dinner')
        tag2 = Tag.objects.create(user=self.user, name='Breakfest')
    ...
    def test_filter_by_ingredients(self):
        ...
        r1 = create_recipe(user=self.user, title='Onion soup')
        r2 = create_recipe(user=self.user, title='Baked potatoes')
